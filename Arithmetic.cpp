...
// Возведение тропического числа в степень
...
// Нахождение мультипликативно-сопряженной матрицы
...
// Поиск спектрального радиуса матрицы
...
// Нормализация вектора первого вида
...
// Нормализация вектора второго вида
...
// Проверка является ли матрица обратно-симметрической 
...
// Проверка матрицы на прямую транзитивность
...
// Поиск оценочного вектора в анализе парных сравнений для произвольных матриц
...
// Решение тропического аналога метода анализа иерархий
